...
<body>
    ...
    <span class="head">Car LeasingKU</span>
    ...
    <span class="form">
     ...
     <form id="form1" name="form1" method="post" action="leasing.php">
       <pre>
        ...
        <div><select name="mobil" id="mobil">
            <option>Avanza Veloz   :  Rp 200.000.000</option>
            <option>Xenia          :  Rp 120.000.000</option>
            <option>Fortuner       :  Rp 500.000.000</option>
            <option>Terios         :  Rp 200.000.000</option>
            <option>Alphard        :  Rp 1.500.000.000</option>
        </select></div>
